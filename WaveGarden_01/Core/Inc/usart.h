...
extern volatile uint8_t uart2_rx_buf[UART2_RX_BUF_SIZE];    // uart2 ?��?�� 버퍼
extern volatile uint8_t uart6_rx_buf[UART6_RX_BUF_SIZE];    // uart3 ?��?�� 버퍼

extern uint8_t uart_data_ready;               // ?��?��?�� ?��?�� ?���? ?��?���?
extern uint16_t uart_rx_length;               // ?��?��?�� ?��?�� 길이

extern uint8_t uart6_data_ready;               // ?��?��?�� ?��?�� ?���? ?��?���?
extern uint16_t uart6_rx_length;               // ?��?��?�� ?��?�� 길이
